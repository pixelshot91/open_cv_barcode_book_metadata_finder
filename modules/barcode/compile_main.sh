...
# clang++ -g -iquote ../include -I /usr/local/include/opencv4/ -lopencv_core -lopencv_imgproc -lopencv_highgui -lopencv_imgcodecs -lopencv_videoio -lopencv_dnn src/*.cpp src/decoder/*.cpp src/decoder/common/*.cpp  src/detector/*.cpp
